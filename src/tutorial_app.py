...
def ProductCard(p):
    ...
    return Card(
        # width:100% makes the image take the full width so we are guaranteed that we won't
        ...
        # height to either stretch, shrink, or crop the image. It is much better to adjust your
        # images to be a consistent size upfront so you don't have to handle edge cases of
        # different images skewing/stretching differently.
